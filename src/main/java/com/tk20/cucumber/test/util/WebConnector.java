...
public class WebConnector {
	...
	static WebConnector w;
		...
		if(OR==null){
			try{
				// initialize OR
				OR = new Properties();
				FileInputStream fs  = new FileInputStream(System.getProperty("user.dir")+"/properties_file/OR.properties");
				OR.load(fs);
				
				// initialize CONFIG to corresponding env
				CONFIG= new Properties();
				fs  = new FileInputStream(System.getProperty("user.dir")+"/properties_file/config.properties");
	...
	public void navigate(String URL) {
		//String URL="https://automation1.tk20.com";
		//log("Naviating to "+CONFIG.getProperty(URL));
		driver.get("https://automation1.tk20.com");
	}
	...
	public static void main(String browserType){
